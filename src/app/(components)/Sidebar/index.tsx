...
const Sidebar = () => {
  ...
  const sidebarClassName = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300 h-full z-40 dark:bg-black orverflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
  return (
      ...
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          ...
          {isSidebarCollapsed ? null : (
            <button
              className="py-3"
              onClick={() => dispatch(setIsSidebarCollapsed(!isSidebarCollapsed))} // Fixed parentheses
            >
        ...
        <nav className="z-10 w-full">
          ...
          <SidebarLink icon={Briefcase} label="Timeline" href="/timelane" />
